...
#SBATCH --output=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/12_feat_compact__spy_qqq__is3_oos1_%j.out
#SBATCH --error=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/12_feat_compact__spy_qqq__is3_oos1_%j.out
...
python walkforward-compare.py \
    ...
    --take-profit 0.1 \
    --wf-max-workers 16 \
    --out-dir "/scratch/lustre/home/ilju3280/hmm-backtrader-sample/results/phase_4/12_feat_compact/spy_qqq/is3_oos1" \
    --regime-mode score \
    --hmm-components 4 \
