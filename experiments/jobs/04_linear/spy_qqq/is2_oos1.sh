#!/bin/bash
#SBATCH --job-name=04_linear__spy_qqq__is2_oos1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --output=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/04_linear__spy_qqq__is2_oos1_%j.out
#SBATCH --error=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/04_linear__spy_qqq__is2_oos1_%j.out
...
python walkforward-compare.py \
    ...
    --take-profit 0.1 \
    --wf-max-workers 16 \
    --out-dir "/scratch/lustre/home/ilju3280/hmm-backtrader-sample/results/phase_1/04_linear/spy_qqq/is2_oos1" \
    --regime-mode linear
