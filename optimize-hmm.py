...
def make_objective(tickers, fromdate, todate, fast, slow,
                   ...
                   kama_period=10,
                   fb_period=20,
                   ct_ema_fast=10, ct_ema_slow=30,
                   ct_rsi_period=7, ct_rsi_buy_low=25, ct_rsi_buy_high=45,
                   ct_rsi_sell_low=55, ct_rsi_sell_high=75, ct_signal_window=10,
                   ct_adx_period=7, ct_adx_threshold=20.0,
                   ct_macd_fast=5, ct_macd_slow=13, ct_macd_signal=4,
                   hmm_features=None,
                   hmm_pca=None,
                   regime_mode='strict',
                   unfav_fraction=0.25,
    ...
    def objective(trial):
        ...
        res = backtest(
            ...
            fb_period           = fb_period,
            ct_ema_fast         = ct_ema_fast,
            ct_ema_slow         = ct_ema_slow,
            ct_rsi_period       = ct_rsi_period,
            ct_rsi_buy_low      = ct_rsi_buy_low,
            ct_rsi_buy_high     = ct_rsi_buy_high,
            ct_rsi_sell_low     = ct_rsi_sell_low,
            ct_rsi_sell_high    = ct_rsi_sell_high,
            ct_signal_window    = ct_signal_window,
            ct_adx_period       = ct_adx_period,
            ct_adx_threshold    = ct_adx_threshold,
            ct_macd_fast        = ct_macd_fast,
            ct_macd_slow        = ct_macd_slow,
            ct_macd_signal      = ct_macd_signal,
            hmm                 = True,
