...
#SBATCH --output=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/14_best_multiasset__sp500_10__is3_oos1_%j.out
#SBATCH --error=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/14_best_multiasset__sp500_10__is3_oos1_%j.out
...
python walkforward-compare.py \
    ...
    --take-profit 0.1 \
    --wf-max-workers 1 \
    --out-dir "/scratch/lustre/home/ilju3280/hmm-backtrader-sample/results/phase_5/14_best_multiasset/sp500_10/is3_oos1" \
    --regime-mode score \
    --hmm-components 4 \
