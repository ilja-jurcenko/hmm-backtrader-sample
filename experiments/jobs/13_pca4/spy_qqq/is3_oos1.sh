#!/bin/bash
#SBATCH --job-name=13_pca4__spy_qqq__is3_oos1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=12:00:00
#SBATCH --output=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/13_pca4__spy_qqq__is3_oos1_%j.out
#SBATCH --error=/scratch/lustre/home/ilju3280/hmm-backtrader-sample/logs/13_pca4__spy_qqq__is3_oos1_%j.out
...
python walkforward-compare.py \
    ...
    --take-profit 0.1 \
    --wf-max-workers 1 \
    --out-dir "/scratch/lustre/home/ilju3280/hmm-backtrader-sample/results/phase_4/13_pca4/spy_qqq/is3_oos1" \
    --regime-mode score \
    --hmm-components 4 \
